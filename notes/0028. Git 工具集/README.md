...
- [4. 🤔 如何清理工作目录？](#4--如何清理工作目录)
- [5. 🤔 如何使用 GPG 签名签署工作？](#5--如何使用-gpg-签名签署工作)
- [6. 🤔 如何使用 git grep 搜索代码？](#6--如何使用-git-grep-搜索代码)
- [7. 🤔 如何使用 git bisect 定位错误提交？](#7--如何使用-git-bisect-定位错误提交)
