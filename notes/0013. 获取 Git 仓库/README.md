...
1. 自行创建：将本地的任意一个文件夹初始化为 git 仓库，`git init`
2. 克隆已有的远程仓库：`git clone`
...
```bash
# 浅克隆：--depth {N} 只获取最近的 N 次提交
git clone --depth 1 https://github.com/user/repo.git
# 对于含有大量 commit 的仓库，如果你不关心这个仓库的历史 commit，只关注它的最新版本
# 可以加上 --depth 1 来进行浅克隆，这样就只会克隆最近的一次提交，节省时间和空间
